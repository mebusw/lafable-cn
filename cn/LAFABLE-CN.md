...
团队`巡游团队`选择交付日期和范围  
	...
	> 
	> 团队给出一个产品完成的预估时间区间。编制这一个估计数字完全是为了取悦利益相关方和外部管理人员。没有人真正关注它。
...
业务方`业务团队`口头上支持团队`巡游团队`的估计  
	...
	> 
	> 虽然口头上答应让团队评估他们自己的工作，但是业务方会根据自己期待获得的功能，脱离现实并异想天开地确定一个交付日期。考虑到开发和测试人员时间的宝贵，最终确定的交付日期也没有征询他们的意见。
...
...但是，他们会挑选一个更早的日期，并且在这个时限内增加更多的功能  
	...
	> 
	> 项目的最后期限公布了。在LAFABLE中，最后期限通常是基于团队的预期完成日期，将其减半并缩小度量单位来确定的。这样，一个预期在4个月内完成任务的团队将获得2周的最后期限。
...
结对管理  
	...
	> 
	> 在结对编程成功的基础上，LAFABLE引入了结对管理，每个开发或测试人员都由两名经理监控着。每项任务都有两双眼睛盯着，每一个微管理的机会都极不可能被忽视。
...
差不多可以开始的定义  
	...
	> 
	> 每一个团队都建立了差不多可以开始的定义。任何任务在满足这个定义之前，都不能被称为已开始。典型的定义内容包括：  
	> <ul>
	> <li>开发人员早上已经喝过咖啡了</li>
...
在我的设备上已完成的定义  
	...
	> 
	> 一旦开发人员看到某个特性在他/她自己的设备上运行了一次，这个特性就可以被报告为“在我的设备上已完成”。在LAFABLE中，资深开发人员需要遵守更高的标准，只有某个特性在他们的设备上运行过多次，才能被称为“在我的设备上已完成”。
...
差不多完成的定义  
	...
	> 
	> 为了避免沟通问题，在LAFABLE中，团队会建立一个“差不多完成”的定义。一旦一项需求差不多完成了，就会被部署到生产环境中。这样会让用户参与到测试过程中。让用户觉得，参与到产品开发过程中比给他们高质量的特性更重要，所以，产品在应该交付给他们之前就交付给他们了。
...
这次我们真的认为完成了的定义  
	...
	> 
	> 终于，功能达到了“团队真的认为完成了”的状态，真的，他们做到了。只是测试人员还没有看到这个功能，测试是稳定阶段才会发生的事。
